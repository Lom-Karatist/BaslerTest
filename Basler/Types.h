 ...
 * @brief Содержит константные списки для отображения в GUI и преобразования строк.
 *
...
namespace BaslerConstants {
    ...
    /**
     * @enum SettingTypes
     * @brief Перечисление всех типов настроек, которые могут изменяться из внешних модулей.
     *
     * Используется в сигнале `settingsWereChanged` для идентификации изменённого параметра.
     */
    enum SettingTypes {
